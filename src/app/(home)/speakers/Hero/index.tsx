...
export const Hero = () => {
  return (
    <section
      className={
        "relative grid lg:grid-cols-2 w-full lg:min-h-screen bg-gray-1300 text-white"
      }
    >
      <Box
        className={
          "col-span-1 flex flex-col justify-center px-6 py-12 lg:p-14 lg:pl-0 gap-12 max-w-[660px] ml-auto"
        }
      >
