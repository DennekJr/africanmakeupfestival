          ...
          <AgoraBox className={'w-full'}>
            <AgoraTransitionBox>
              <Box className={'relative'}>
                <span className={'mb-[1em] text-[14px] uppercase font-semibold text-primary block text-center'}>Speakers</span>
                <h1 className={'leading-[1em] m-0 items-center text-primary text-[32px] md:text-[48px] lg:text-[3.535em] font-bold text-center'}>Visiting Speakers</h1>
              </Box>
            </AgoraTransitionBox>
