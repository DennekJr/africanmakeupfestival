...
export const Benefits = () => {
  ...
  return (
    <Box className={"w-full py-24 lg:py-32 bg-midGrey"}>
            ...
            return (
              <Box
                ...
                <Box className="col-span-1"><p
                  className="text-[23px] leading-[27.6px] md:text-5xl lg:leading-normal text-xl font-medium text-lightSecondary">{benefit.title}</p>
                </Box>
