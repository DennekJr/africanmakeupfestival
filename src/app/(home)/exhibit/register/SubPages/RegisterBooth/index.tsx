      ...
      <Box className={"w-full max-w-[1320px] mx-auto space-y-6 lg:space-y-8"}>
        <Box className={"w-full lg:flex space-y-3 lg:space-y-0"}>
          ...
          >
              <pre
                id="undefined-0"
                className="text-[#1E1C21] font-sans w-full break-words whitespace-pre-wrap min-h-6 font-medium heading text-[32px] leading-[35.2px] lg:text-6xl lg:leading-[66px] tracking-[-1px]"
              >
          ...
          <Box className={"w-full max-w-screen-form mr-auto flex-1"}>
              <pre
                id="undefined-0"
                className="font-sans w-full break-words whitespace-pre-wrap min-h-6 heading text-xl font-normal"
              >
                <span className="relative max-w-full break-words text-[#1E1C21]">
