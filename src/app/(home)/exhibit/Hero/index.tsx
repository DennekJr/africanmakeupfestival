...
export const Hero = () => {
  return (
    <section
      className={
        "relative grid lg:grid-cols-2 w-full lg:min-h-screen bg-black text-white"
      }
    >
      <Box
        className={
          "col-span-1 flex flex-col justify-center !px-6 py-12 lg:p-14 gap-12 mr-auto max-w-[660px] ml-auto"
        }
      >
            ...
            >
              ...
              <span className="relative max-w-full break-words text-textColor">
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="max-w-full absolute left-0 -bottom-2 lg:w-[266px] md:-w-[166px] w-[100px]"
                >
                  <path
