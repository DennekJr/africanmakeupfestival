...
<h3>ONE MORE STEP!</h3>
<h3>Congratulations on your <span style="color: #C43C2A">#ASF</span> booking confirmation!</h3>
<!--<h3>Reservation Reference: ${reference}</h3>-->
<h4>Hi ${name},</h4>  
<p>Your booking confirmation number is <span style="color: #C43C2A">${reference}</span>.
...
<div class="centralise" style="width: 100%; display: flex; text-align: center; justify-content: center; align-items: center;">
<a href='${paymentUrl}' style="text-decoration: none; padding: 10px 15px; background: #C43C2A; color: #ffffff; font-weight: bold">Complete Payment</a>
</div>
<div class="centralise" style="width: 100%; padding: 10px; display: flex; justify-content: center; align-items: center; text-align: center;"><img src="${imageUrl}" alt="QR Code" style="width: 120px; height: 120px;" /></div>
